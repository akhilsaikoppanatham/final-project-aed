...
public class ProcessWorkRequestJPanel extends javax.swing.JPanel {
    ...
    GarageWorkRequest request;
    Enterprise.EnterpriseType enterPriseType;
    Automobile visitor;
    String testName;
    Enterprise.EnterpriseType outletType = Enterprise.EnterpriseType.OutletEnterprise;

    Enterprise.EnterpriseType researchType = Enterprise.EnterpriseType.AutoMechanicEnterprise;

    /**
     * Creates new form ProcessWorkRequestJPanel
     */
    public ProcessWorkRequestJPanel(JPanel userProcessContainer, GarageWorkRequest request, Enterprise.EnterpriseType enterPriseType, Automobile visitor, String testName) {
        initComponents();
        ...
        if (this.enterPriseType == outletType) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Automobile Component Test Result");
        ...
        jLabel2.setText("Performance Indicator Value");
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("/Users/akhilsaikoppanatham/Documents/GitHub/final-project-aed/DriveLineSupplyChainManagement/assets/spinner.gif")); // NOI18N
    ...
    private void backJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backJButtonActionPerformed
        ...
        QAWorkAreaJPanel dwjp = (QAWorkAreaJPanel) component;
        dwjp.populateTable();
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        ...
        if (this.enterPriseType == researchType) {
            ...
            request.setStatus("Completed");
            request.setFileupload(ImagePathTextField.getText());
            if (this.testName.equals("Diagnostic1")) {
                Check check1 = visitor.searchCheck("Check1");
                check1.setPerformanceMetricNumber(antibodiesCount1);
            }

            if (this.testName.equals("Diagnostic2")) {
                Check check2 = visitor.searchCheck("Check2");
                check2.setPerformanceMetricNumber(antibodiesCount1);
            }
            if (this.testName.equals("Diagnostic3")) {
                Check check3 = visitor.searchCheck("Check3");
                check3.setPerformanceMetricNumber(antibodiesCount1);
            }

            if (this.testName.equals("Diagnostic4")) {
                Check check4 = visitor.searchCheck("Check4");
                check4.setPerformanceMetricNumber(antibodiesCount1);
            }
        }
