...
public class QAWorkAreaJPanel extends javax.swing.JPanel {
     ...
     */
    public QAWorkAreaJPanel(JPanel userProcessContainer, UserAccount account, Organization organization, EcoSystem business) {
        initComponents();
    ...
    public void populateTable(){
        ...
        for(WorkRequest request : this.labOrganization.getWorkQueue().getWorkRequestList()){
            ...
            row[4] = labTestWorkRequest.getAutomobileName();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("/Users/akhilsaikoppanatham/Documents/GitHub/final-project-aed/DriveLineSupplyChainManagement/assets/spinner.gif")); // NOI18N
        add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 210, -1, -1));
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        GarageWorkRequest request = (GarageWorkRequest)workRequestJTable.getValueAt(selectedRow, 0);
        ...
        Automobile v1=getPatient(request);
    ...
    public Automobile getPatient(GarageWorkRequest request) {
                ...
                for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                    if (enterprise.getEnterpriseType() == type) {
                      for( Organization o: enterprise.getOrganizationDirectory().getOrganizationList())
                          if((o.getName().equals("AutomobileOrganization"))){
                            for (Automobile v : o.getAutomobileDirectory().getAutomobileList()) {
