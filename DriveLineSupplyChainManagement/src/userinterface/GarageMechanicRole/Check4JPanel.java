...
public class Check4JPanel extends javax.swing.JPanel {
    ...
    public Check4JPanel(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise,EcoSystem business) {
        initComponents();
...
public void populateTable(){
          ...
          if (enterprise.getEnterpriseType() == type) {
           enterprise.getOrganizationDirectory().getOrganizationList().stream().filter((organization) 
             ...
             for (Automobile v: organization.getAutomobileDirectory().getAutomobileList()) {
                 ...
                 Check phase3 = v.searchCheck("Phase3");
              Check phase = v.searchCheck("Phase4");
             try{ if ((phase1.getCheckStatus().equals("success")||phase1.getCheckStatus().equals("failure"))&&(phase2.getCheckStatus().equals("success")||phase2.getCheckStatus().equals("failure"))&&(phase3.getCheckStatus().equals("success")||phase3.getCheckStatus().equals("failure"))&&(phase.getCheckStatus().equals("initialized") || phase.getCheckStatus().equals("processing"))) {
               ...
               row[7]= phase3.getCheckStatus();
               row[8]= phase.getCheckStatus();
    ...
    private void initComponents() {
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Automobile Name", "Message", "Sender", "Receiver", "Status", "Check1", "Check2", "Check3", "Check4", "Week1", "Week2", "Week3", "Week4"
            }
        ) {
   ...
   int selectedRow = workRequestJTable.getSelectedRow();
       ...
       Check phase = visitor.searchCheck("Phase4");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       ...
       if(o!=null){
          ...
          if(o.getWorkQueue().searchRequest(name, "Diagnostic4")) {
           ...
           GarageWorkRequest request = new GarageWorkRequest();
            request.setMessage("Garage is currently looking into this issue");
