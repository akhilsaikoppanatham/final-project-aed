...
public class DealerWorkAreaJPanel extends javax.swing.JPanel {
   ...
   JPanel container;
     ...
     */
    public DealerWorkAreaJPanel(JPanel container, Enterprise enterprise,UserAccount account, EcoSystem business) {
      initComponents();
    ...
    private void initComponents() {
        ...
        PatientJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Car Name", "Expert Assigned", "Status"
            }
        ) {
    ...
    private void assignJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignJButtonActionPerformed
        ...
        Automobile patient = (Automobile)PatientJTable.getValueAt(selectedRow, 0);
        try{
         if (!(patient.getAssignedDealer().equals("")||patient.getAssignedDealer()==null)){
        ...
        patient.setAssignedDealer(account);
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        if(!patient.getAssignedDealer().getUsername().equals(account.getUsername())){
            JOptionPane.showMessageDialog(null, "You are not the assigned user for this patient.");
            return;
        }
        patient.setStatus("Processing");
        ManageAutomobilesJPanel managePatientsJPanel = new ManageAutomobilesJPanel(container,enterprise,account,patient, business);
